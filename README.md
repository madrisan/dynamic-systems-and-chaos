...
##### bifurcations.py
    ...
    Example:
      ./bifurcations.py -r 0:4
      ./bifurcations.py -r 3.0:3.5 -s 2000 -n 1000
...
#### Bifurcation Diagrams
    ...
    ./bifurcations.py -r 2:4 -n 600 -s 500

![alt tag](https://github.com/madrisan/dynamic-systems-and-chaos/blob/master/plots/plot07_le-bifurcation-diagram.png)
